...
HotelService hotelService=new HotelService();
    ...
    public String getHotelWithMostFacilities(){
        ...
        String response=hotelService.getHotelWithMostFacilities();
        return response;
    }
    ...
    public int bookARoom(@RequestBody Booking booking){
        ...
        int response=hotelService.bookARoom(booking);
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        int response=hotelService.getBookings(aadharCard);
        return response;
    }
    ...
    public Hotel updateFacilities(List<Facility> newFacilities,String hotelName){
        ...
        Hotel response =hotelService.updateFacilities(newFacilities,hotelName);
